...
export const exportTransporteExcel = async (req, res) => {
  try {
    ...
    worksheet.columns = [
      ...
      { header: "Fecha de Vencimiento", key: "fechaVen", width: 20 },
      { header: "Almacén de Devolución", key: "almacenDev", width: 30 },
      { header: "Comprobante de Devolución", key: "comprobanteDev", width: 30 },
      { header: "Fecha de Devolución", key: "fechaDev", width: 20 },
      { header: "Conductor de Devolución", key: "conductorDev", width: 30 },
      { header: "Placa de Devolución", key: "placaDev", width: 15 },
    ...
    transportes.forEach((transporte) => {
      worksheet.addRow({
        ...
        fechaVen: transporte.fechaVen,
        almacenDev: transporte.almacenDev,
        comprobanteDev: transporte.comprobanteDev,
        fechaDev: transporte.fechaDev,
        conductorDev: transporte.conductorDev,
        placaDev: transporte.placaDev,
